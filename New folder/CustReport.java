...
class CustReport
{
	public CustReport()
	{
		...
		Class.forName("com.mysql.cj.jdbc.Driver");
    		...
    		BufferedWriter bw=new BufferedWriter(new FileWriter("CustReport.html"));
    		bw.write("<html>");
    		...
    		bw.write("<h2><center> <font color='green'>CUSTOMER DETAILS REPORT </font></center></h1>");
			...
			r.exec("explorer CustReport.html");
			bw.close();
		}
		catch(Exception e)
		{

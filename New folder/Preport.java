...
class Preport
{
	public Preport()
	{
		...
		Class.forName("com.mysql.cj.jdbc.Driver");
    		...
    		BufferedWriter bw=new BufferedWriter(new FileWriter("PurchesRep.html"));
    		bw.write("<html>");
    		...
    		bw.write("<h2><center> <font color='green'>ORDRE DETAIL REPORT </font></center></h1>");
